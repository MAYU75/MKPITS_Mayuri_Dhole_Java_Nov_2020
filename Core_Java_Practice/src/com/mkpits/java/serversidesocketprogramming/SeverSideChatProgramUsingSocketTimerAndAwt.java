...
public class SeverSideChatProgramUsingSocketTimerAndAwt extends Frame {
    Label l1, l2;
    TextField t1;
    Button b1, b2;
    TextArea ta;
    ...
    SeverSideChatProgramUsingSocketTimerAndAwt() {
...
*/
                    ...
                    TimerTask task = new TimerClassServer(new SeverSideChatProgramUsingSocketTimerAndAwt(), ss, s);
    ...
    public static void main(String[] args) {
        ...
        SeverSideChatProgramUsingSocketTimerAndAwt a1 = new SeverSideChatProgramUsingSocketTimerAndAwt();
