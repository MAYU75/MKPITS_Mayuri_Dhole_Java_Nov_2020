//Java program to demonstrate designing of Registration Form.
...
public class DesigningRegistrationFormUsingAWT {
    Label l1, l2, l3, l4;
    TextField tf;
    Button b1;

    DesigningRegistrationFormUsingAWT() {
    ...
    public static void main(String[] args) {
        new DesigningRegistrationFormUsingAWT();
    }
