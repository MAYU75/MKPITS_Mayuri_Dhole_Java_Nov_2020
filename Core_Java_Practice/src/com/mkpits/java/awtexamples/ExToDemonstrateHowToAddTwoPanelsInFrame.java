//Java program to demonstrate how to add two Panels in Frame.

package src.com.mkpits.java.awtexamples;

import java.awt.*;

public class ExToDemonstrateHowToAddTwoPanelsInFrame {
    ExToDemonstrateHowToAddTwoPanelsInFrame() {
    ...
    public static void main(String[] args) {
        new ExToDemonstrateHowToAddTwoPanelsInFrame();
    }
