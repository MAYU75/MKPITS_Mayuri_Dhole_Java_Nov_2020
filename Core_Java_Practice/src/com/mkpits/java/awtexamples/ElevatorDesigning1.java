...
public class ElevatorDesigning1 extends Frame {
    ...
    ElevatorDesigning1() {
        ...
        ButtonClass bt8 = new ButtonClass(this);
        b8.addActionListener(bt8);//passing outer class instance
        fr.add(b8);
...
class ButtonClass extends ElevatorDesigning1 implements ActionListener {
    ElevatorDesigning1 ev1;

    ButtonClass(ElevatorDesigning1 obj) {
        this.ev1 = obj;
    }
