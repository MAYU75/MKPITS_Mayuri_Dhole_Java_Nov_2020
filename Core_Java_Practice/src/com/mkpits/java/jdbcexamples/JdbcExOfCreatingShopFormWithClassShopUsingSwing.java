//Java program to demonstrate how to create Shop form with class Shop using Swing.
...
public class JdbcExOfCreatingShopFormWithClassShopUsingSwing extends JFrame {
    ...
    public JdbcExOfCreatingShopFormWithClassShopUsingSwing() {
        s1 = new Shop();
    ...
    public static void main(String[] args) {
        JdbcExOfCreatingShopFormWithClassShopUsingSwing sf = new JdbcExOfCreatingShopFormWithClassShopUsingSwing();
    }
}
