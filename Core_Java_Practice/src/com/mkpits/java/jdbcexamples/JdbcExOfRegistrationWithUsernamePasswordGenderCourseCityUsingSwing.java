//Java program to demonstrate how to insert username, password, gender, course and city data
...
public class JdbcExOfRegistrationWithUsernamePasswordGenderCourseCityUsingSwing extends JFrame {
    JRadioButton rb1;
    JRadioButton rb2;
    ButtonGroup bg;
    JCheckBox cb1, cb2;
    ...
    JdbcExOfRegistrationWithUsernamePasswordGenderCourseCityUsingSwing() {
        ...
        b1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    l21.setText("registered successful");
                    t1.setText("");
                    t2.setText("");
                    st.close();
                    con.close();
    ...
    public static void main(String[] args) {
        JdbcExOfRegistrationWithUsernamePasswordGenderCourseCityUsingSwing f = new JdbcExOfRegistrationWithUsernamePasswordGenderCourseCityUsingSwing();
    }
}
