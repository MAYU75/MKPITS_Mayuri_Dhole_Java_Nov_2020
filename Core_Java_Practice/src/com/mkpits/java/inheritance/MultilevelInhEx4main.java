...
//////////////////////////////
class StudentMultilevelInhEx4 extends PersonMultilevelInhEx4
{
	int rno,marks;
...
//////////////////////////////////
class ParttimeStudentMultilevelInhEx4 extends StudentMultilevelInhEx4
{
	int noofhours;
...
class MultilevelInhEx4main
{
    public static void main(String[] args)
    {
    	...
    	ParttimeStudentMultilevelInhEx4  stud=new ParttimeStudentMultilevelInhEx4();
