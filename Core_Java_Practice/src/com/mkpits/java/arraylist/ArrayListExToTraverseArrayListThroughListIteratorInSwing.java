//Java program to traverse ArrayList through ListIterator in Swing.
...
public class ArrayListExToTraverseArrayListThroughListIteratorInSwing extends JFrame {
    JLabel l1, l2;
    JTextField t1, t2;
    JTextArea ta;
    ...
    public ArrayListExToTraverseArrayListThroughListIteratorInSwing() {
    ...
    public static void main(String[] args) {
        ArrayListExToTraverseArrayListThroughListIteratorInSwing arl = new ArrayListExToTraverseArrayListThroughListIteratorInSwing();
    }
