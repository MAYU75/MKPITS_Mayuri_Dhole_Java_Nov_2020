//Java program to demonstrate set() and get() method using AWT.
...
public class ArrayListExToDemonstrateSetAndGetMethodUsingAwt extends Frame {
    Label l1, l2;
    TextField t1, t2;
    TextArea ta;
    Button b1, b2, b3, b4;
    ...
    public ArrayListExToDemonstrateSetAndGetMethodUsingAwt() {
    ...
    public static void main(String[] args) {
        ArrayListExToDemonstrateSetAndGetMethodUsingAwt arl = new ArrayListExToDemonstrateSetAndGetMethodUsingAwt();
    }
