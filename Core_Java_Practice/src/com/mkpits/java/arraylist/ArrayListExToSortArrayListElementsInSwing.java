//Java program to sort ArrayList elements in Swing.
...
public class ArrayListExToSortArrayListElementsInSwing extends JFrame {
    JLabel l1, l2;
    JTextField t1, t2;
    JTextArea ta;
    ...
    public ArrayListExToSortArrayListElementsInSwing() {
    ...
    public static void main(String[] args) {
        ArrayListExToSortArrayListElementsInSwing arl = new ArrayListExToSortArrayListElementsInSwing();
    }
