//Java program to demonstrate set() and get() method using Swing.
...
public class ArrayListExToDemonstrateSetAndGetMethodUsingSwing extends JFrame {
    JLabel l1, l2;
    JTextField t1, t2;
    JTextArea ta;
    JButton b1, b2, b3, b4;
    ...
    public ArrayListExToDemonstrateSetAndGetMethodUsingSwing() {
    ...
    public static void main(String[] args) {
        ArrayListExToDemonstrateSetAndGetMethodUsingSwing arl = new ArrayListExToDemonstrateSetAndGetMethodUsingSwing();
    }
