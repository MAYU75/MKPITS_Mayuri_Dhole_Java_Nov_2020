//Java program to demonstrate ArrayList using AWT.
...
public class ArrayListExampleUsingAwt extends Frame {
    Label l1, l2;
    TextField t1;
    TextArea ta;
    Button b1, b2;
    ...
    public ArrayListExampleUsingAwt() {
    ...
    public static void main(String[] args) {
        ArrayListExampleUsingAwt arl = new ArrayListExampleUsingAwt();
    }
